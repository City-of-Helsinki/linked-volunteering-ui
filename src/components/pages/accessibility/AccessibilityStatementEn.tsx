  ...
  return (
    <ContentWrapper lang="en">
      ...
      <p>
        ...
        ensure that all residents are able to move about and act as effortlessly as possible and
        that all content and services are accessible to all.
      </p>
      <p>
        The city promotes accessibility of digital services by streamlining publishing work and
        organising accessibility-related training for its staff.
      </p>
      <p>
      ...
      <p>
        ...
        technologies. Support is available on guidance sites announced on the city’s website and
