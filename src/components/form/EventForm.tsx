...
import { AutoSuggestEvent } from './fields/AutoSuggest';
...
export interface EventFormProps extends Partial<FormikProps<Event>> {
  ...
  setFieldValue: (field: string, value: any, shouldValidate?: boolean) => Promise<void> | Promise<FormikErrors<Event>>;
  setFieldTouched: (
    field: string,
    touched?: boolean,
    shouldValidate?: boolean,
  ) => Promise<void> | Promise<FormikErrors<Event>>;
}
